...
*/
/*#define IDN_DEL_SISTEMA*/ char IdentidadDelSistema[]="Slave I2C";
//------------------------------------------------------------------------------------------
// Ficheros include                                                          
//------------------------------------------------------------------------------------------
#include <ansi_c.h>
...
char SParametros[STRMEDIO];	// Cadena para poner un parámetros en los comandos
int Parametro; //Valor del parámetro
 ...
 int main (int argc, char *argv[])
{
	...
	if ((PrincipalHandle = LoadPanel (0, "SlaveI2C.uir", PRINCIPAL)) < 0)
		return -1;
