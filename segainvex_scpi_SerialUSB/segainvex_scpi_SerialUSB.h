/*******************************************************************************
 ...
 Fichero de cabecera Segainvex_SCPI.h
/******************************************************************************
/*
...
/* 
 Mejoras futuras:
 1)Poner el menú de Segainvex_SCPI en flash para no consumir RAM
 ...
 *******************************************************************************/
#ifndef SEGAINVEX_SCPI_H_INCLUDED
#define SEGAINVEX_SCPI_H_INCLUDED
...
********************************************************************************/
#define BUFFCOM_SIZE 32 //Longitud del buffer de lectura de de Segainvex_SCPI
#define LONG_SCPI 32 // Longitud máxima del comando mas largo sin contar parámetros
#define MAXERR 6   // Profundidad de la pila de errores
/*******************************************************************************
...
/********************************************************************************
  ...
  Son globales todos los modulos con el include a segainvex_scpi.h  						
********************************************************************************/
...
3)	Si Arduino lee con SerialUSB.readBytesUntil('\r',buffer,tamaño_buffer);.
	...
	hay que ponerselo, ya que SEGAINVEX_SCPI necesita un terminador para dar por 
...
*/
/**************************************************************************/
#endif // SEGAINVEX_SCPI_H_INCLUDED
/***********************************FIN************************************/
