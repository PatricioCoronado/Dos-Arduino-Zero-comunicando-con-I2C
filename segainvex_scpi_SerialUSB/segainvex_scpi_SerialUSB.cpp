/*************************************************************************************
	DEPARTAMENTO DE ELECTRÓNICA DE SEGAINVEX. UNIVERSIDA AUTONOMA DE MADRID				
				LIBRERIA PARA ARDUINO SEGAINVEX_SCPI V1.0
 SISTEMA PARA COMUNICAR UNA COMPUTADORA CON ARDUINO MEDIANTE PUERTO SERIE 
 Fichero de código Segainvex_scpi.cpp
**************************************************************************************/
/*
	Copyright © 2017 Mariano Cuenca, Patricio Coronado
	
	This file is part of segainvex_scpi.

    segainvex_scpi is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    segainvex_scpi is distributed in the hope that it will be useful,
    but WITHOUT ANY WARRANTY; without even the implied warranty of
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU General Public License for more details.

    You should have received a copy of the GNU General Public License
    along with segainvex_scpi.  If not, see <http://www.gnu.org/licenses/>
*/
/************************************************************************************
...
**************************************************************************************/
#include <Arduino.h>
#include "segainvex_scpi_SerialUSB.h"//Declaraciones privadas de segainvex_scpi
/************************************************************************************
...
/********************************************************************************************
  Gestiona la pila de errores de SEGAINVEX_SCPI
********************************************************************************************/
...
/**************************************************************************************************
								FUNCION DE ENTRADA A SEGAINVEX_SCPI
			SEGAINVEX_SCPI busca cadenas válidas que podrían ser comandos en la cadena de entrada.
...
/*********************************************************************************************
						FUNCIONES SEGAINVEX_SCPI COMUNES A TODOS LOS SISTEMAS 
**********************************************************************************************/
/**********************************************************************
    Comando: *IDN"
    Función:240
 ...
 *********************************************************************/
void fs248(void){SerialUSB.println("1");}
/**********************************************************************
    Comando: CLS
    Función:255
...
int cambia_variable_double_del_sistema(double *pVariableDelSistema,double Maximo, double Minimo)
{
  ...
  if(FinComando[0]=='?')  {SerialUSB.println(*pVariableDelSistema);return 2;}      
...
// Si el número de parámetros leidos es correcto comprueba los rangos
  if ((Var<=Maximo && Var>=Minimo)){*pVariableDelSistema=Var;return 1;} //si está en rango, cambia la variable
